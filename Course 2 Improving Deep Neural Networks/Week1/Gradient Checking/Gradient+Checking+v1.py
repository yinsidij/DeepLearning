...
def gradient_check_n(parameters, gradients, X, Y, epsilon = 1e-7):
    ...
    for i in range(num_parameters):
        ...
        print ("i= ",i)
        print (parameters_values.shape[0])
        print (parameters_values.shape[1])
        thetaplus = np.copy(parameters_values)                                         # Step 1
        thetaplus[i][0] = thetaplus[i][0]+epsilon                                      # Step 2
        J_plus[i], _ = forward_propagation_n(X, Y, vector_to_dictionary(thetaplus[i])) # Step 3
        ### END CODE HERE ###
        ...
        J_minus[i], _ = forward_propagation_n(X, Y, vector_to_dictionary(thetaminus[i]))                                  # Step 3
        ### END CODE HERE ###
